...
import 'package:stackerbee_app/view/Pages/box_packing_list.dart';
...
class PickDetail extends StatelessWidget {
  ...
  PickDetail({Key? key}) : super(key: key);
                  ...
                  child: Row(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          commonText('Purchase Receipt Lines', fontSize: 12),
                          SizedBox(
                            height: fontSize,
                          ),
                          Row(
...
class PickSubmitDetailsPopup extends StatelessWidget {
  const PickSubmitDetailsPopup({super.key});
                        ...
                        child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => BoxPackingList()));
                            },
                            child: Text(
                              "Yes",
                              style: TextStyle(color: Colors.white),
